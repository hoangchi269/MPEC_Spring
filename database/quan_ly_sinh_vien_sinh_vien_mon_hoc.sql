...
CREATE TABLE `sinh_vien_mon_hoc` (
  ...
  `ngay_tao` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `xoa` bit(1) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_Sinh_vien_mon_hoc_sinh_vien_Id_id_idx` (`sinh_vien_id`),
  KEY `fk_Sinh_vien_mon_hoc_mon_hoc_Id_id_idx` (`mon_hoc_id`),
  CONSTRAINT `fk_Sinh_vien_mon_hoc_mon_hoc_Id_id` FOREIGN KEY (`mon_hoc_id`) REFERENCES `mon_hoc` (`id`),
  CONSTRAINT `fk_Sinh_vien_mon_hoc_sinh_vien_Id_id` FOREIGN KEY (`sinh_vien_id`) REFERENCES `sinh_vien` (`id`)
